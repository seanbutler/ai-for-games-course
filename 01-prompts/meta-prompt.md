...
### Step 2 / read 01-prompts/generate-structure-prompt.md
  ...
  2 save the module outline in '02-outline/'
...
### Step 3 / read 01-prompt/assessmentbrief-prompt.md
  ...
  2 save the the assessment brief in '03-assessment/assessment-brief.md'
  3 generate a staff facing marking guidance
  4 save the the assessment brief in '03-assessment/marking-guidance-STAFF.md'
  5 generate a student facing marking rubric 
  6 save the the assessment brief in '03-assessment/marking-rubric-STUDENT.md'
